...
function Form(){
    ...
    <section className="section">
      ...
      <table id = "tab_cadastro" className="conta_agua" cellSpacing={"11"}>
        ...
        <fieldset className="grupo">
         <tr className="campo"> 
          ...
          <tr className="campo" >
            <td><input id="documento" name="documento" type="number" placeholder="Nª do Documento"  /></td>
          </tr>
          <tr className="campo" >
            <td><input id="dataemi" name="dataemi" type="text" placeholder="Data de Emissão"  /></td>
          </tr>
          {/* <tr className="campo">
        ...
        <tr className="campo" > 
          ...
          <tr className="campo">
            <td><input id="dataapre" name="dataapr" type="text"  placeholder="Data de Apresentação"/></td>
          </tr>
          <tr className="campo">
